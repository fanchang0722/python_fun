...
directory = r'/Users/fanchang/Result/JSON'
fileList = os.listdir(directory)
outfile = r'/Users/fanchang/Downloads/P2_all_SFR.csv'
fout = open(outfile, 'w')
...
for filename in fileList:
    if filename.endswith('SFR_Pos.json') and os.path.getsize(os.path.join(directory, filename)) > 0:
        count += 1
        temp = ''
        print filename
        temp += filename[:16]+','
